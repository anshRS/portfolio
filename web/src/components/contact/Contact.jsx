                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">{process.env.REACT_APP_YOUR_EMAIL}</span>

                            <a href={`mailto:${process.env.REACT_APP_YOUR_EMAIL}`} className="contact__button">Write me{" "} <i className="ri-arrow-right-line contact__button-icon"></i></a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            > Write me{" "} <i className="ri-arrow-right-line contact__button-icon"></i>
                            </a>
                        </div>
